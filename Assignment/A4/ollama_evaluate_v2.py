...
def resolve_url(user_url, port=11434):
    ...
    # Normalize common typos like "https:" (missing slashes)
    if user_url.startswith("https:") and not user_url.startswith("https://"):
        user_url = "https://" + user_url[6:]
    elif user_url.startswith("http:") and not user_url.startswith("http://"):
        user_url = "http://" + user_url[5:]
